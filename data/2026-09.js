...
dayMeta["2026-09-09"] = {
  status: "VERIFICADO ✓",
  subtitle: "Relación con Estados Unidos, porte de armas, control político, educación, economía, gobernabilidad, inteligencia y reincorporación."
};
...
events.push(
...

  {
    ...
    summary: "Un mes después del terremoto de magnitud 7,4 que golpeó el occidente colombiano, el balance actualizado reporta 331 personas fallecidas, 4.505 heridas, 36.326 viviendas destruidas y 202.002 averiadas. El desastre afectó 498 municipios de 16 departamentos y a más de 466.700 personas.",
    eventDate: "2026-08-10",
    publishedDate: "2026-09-10",
    sourceType: "Balance oficial reportado por prensa",
    sourceName: "Tropicana / UNGRD",
    sourceUrl: "https://www.tropicanafm.com/2026/se-cumple-1-mes-del-terremoto-de-7-4-cifras-actualizadas-y-como-acceder-al-apoyo-economico-475725.html",
    ...
    whyItMatters: "Las nuevas cifras permiten dimensionar el impacto humano y material del mayor desastre que enfrenta actualmente el país.",
    extraSources: []
  },

  // ---------------------------------------------------------
  // GOBIERNO · ECONOMÍA Y RECONSTRUCCIÓN
  // ---------------------------------------------------------

  {
    ...
    summary: "El costo de la reconstrucción se estima en alrededor de $42,1 billones, equivalentes a cerca del 2,3 % del PIB. El Gobierno enfrenta el reto de financiar la recuperación mientras intenta reducir el déficit fiscal, reorientar gasto público y conseguir nuevas fuentes de financiación.",
    ...
    whyItMatters: "La reconstrucción obliga al Gobierno a conciliar dos objetivos difíciles de ejecutar simultáneamente: reducir el gasto y financiar una recuperación de gran escala.",
    extraSources: []
  },
...

  {
    ...
    summary: "Comunidades de Sipí afectadas por el terremoto enfrentan ahora una nueva emergencia por enfrentamientos entre el ELN y el Clan del Golfo. Cerca de 175 familias de Charco Largo, Charco Hondo y Barrancón se desplazaron hacia Istmina en medio de combates y del temor por la presencia de explosivos.",
    ...
    whyItMatters: "Las comunidades están enfrentando simultáneamente las consecuencias del desastre natural y el recrudecimiento del conflicto armado.",
    extraSources: []
  },
...

  {
    ...
    category: "JUSTICIA",
    importance: "IMPORTANTE",
    title: "Juez ordena ocultar temporalmente videos del presidente junto a cadáveres",
    summary: "Un juez ordenó que sean ocultados temporalmente de las redes sociales videos en los que el presidente Abelardo De La Espriella aparece junto a cuerpos de presuntos integrantes de estructuras criminales muertos durante operaciones de la Fuerza Pública. La decisión se produjo después de una acción presentada por un congresista de la Alianza Verde.",
    eventDate: "2026-09-10",
    publishedDate: "2026-09-10",
    sourceType: "Decisión judicial reportada por prensa",
    sourceName: "Folha de S.Paulo",
    sourceUrl: "https://www1.folha.uol.com.br/mundo/2026/09/juiz-ordena-que-presidente-da-colombia-oculte-das-redes-videos-ao-lado-de-cadaveres.shtml",
    status: "Orden judicial",
    related: [
      "Abelardo De La Espriella",
      "justicia",
      "redes sociales",
    ...
    whyItMatters: "La decisión lleva al terreno judicial la controversia sobre la manera en que el Gobierno comunica públicamente los resultados de operaciones militares.",
    note: "La medida es de carácter temporal y no constituye una decisión definitiva sobre el fondo de la controversia.",
    extraSources: []
  },
...

  {
    ...
    importance: "RELEVANTE",
    title: "Gobierno reemplaza 'campesino' por 'empresario del campo' en sus comunicaciones",
    summary: "El ministro de Agricultura, Indalecio Dangond, ordenó a su equipo utilizar la expresión 'empresario del campo' en lugar de 'campesino' en las comunicaciones oficiales. El ministro sostiene que busca dignificar el trabajo rural, mientras organizaciones campesinas y otros sectores cuestionan la decisión y reivindican la identidad campesina reconocida constitucionalmente.",
    eventDate: "2026-09-09",
    publishedDate: "2026-09-10",
    sourceType: "Fuente periodística",
    sourceName: "El País",
    ...
    status: "Decisión administrativa y debate público",
    related: [
    ...
    whyItMatters: "El término 'campesino' tiene reconocimiento constitucional en Colombia, por lo que el cambio de lenguaje abrió una discusión que trasciende la comunicación institucional.",
    extraSources: []
  },
...

  {
    ...
    summary: "La decisión del Gobierno de levantar la suspensión general de los permisos para el porte de armas continúa generando cuestionamientos. Expertos y sectores críticos advierten sobre posibles efectos en hechos de intolerancia y violencia, mientras el Ejecutivo sostiene que la medida permite ejercer el derecho a la defensa dentro de los requisitos legales.",
    eventDate: "2026-09-08",
    publishedDate: "2026-09-10",
    sourceType: "Debate público reportado por prensa",
    sourceName: "Folha de S.Paulo",
    sourceUrl: "https://www1.folha.uol.com.br/mundo/2026/09/presidente-da-colombia-revoga-decreto-que-restringia-porte-de-armas.shtml",
    ...
    whyItMatters: "La modificación de una política vigente durante años puede tener efectos sobre seguridad ciudadana y se ha convertido en uno de los principales debates del comienzo del Gobierno.",
    note: "El levantamiento de la suspensión general no equivale a autorizar el porte irrestricto de armas.",
    extraSources: []
  },
