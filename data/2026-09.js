...
{
  date: "2026-09-07",
  label: "7 de septiembre",
  government: [
    {
      title: "Gobierno y empresarios trazan plan de reconstrucción para el Chocó",
      text: "El presidente Abelardo De La Espriella encabezó en Quibdó una cumbre con empresarios para coordinar recursos públicos y privados destinados a la recuperación y reconstrucción de las zonas afectadas por el terremoto. El Gobierno anunció proyectos y estrategias para el departamento y designó un gerente especial para hacer seguimiento a las iniciativas prioritarias.",
      source: "Presidencia de la República",
      url: "https://www.presidencia.gov.co/prensa/Paginas/Presidente-De-La-Espriella-liderara-este-lunes-cumbre-empresarial-para-transformar-el-Choco-y-reconstruir-260906.aspx"
    },
    {
      title: "Gobierno activa el Plan Energía YA ante el fenómeno de El Niño",
      text: "El Gobierno anunció el Plan Energía YA para anticiparse a los posibles efectos del fenómeno de El Niño y proteger el suministro eléctrico. La estrategia contempla medidas de ahorro de energía y mecanismos para garantizar generación térmica y preservar las reservas de los embalses.",
      source: "Presidencia de la República",
      url: "https://www.presidencia.gov.co/prensa/Paginas/Gobierno-activa-Plan-Energia-YA-para-enfrentar-fenomeno-de-El-Nino-y-proteger-el-suministro-electrico-260907.aspx"
    },
    {
      title: "Gobierno presenta balance de seguridad de su primer mes",
      text: "La Presidencia presentó un balance de las operaciones de la Fuerza Pública desde el 7 de agosto. Según cifras preliminares del Ministerio de Defensa divulgadas por el Gobierno, durante el periodo se registraron cerca de 15.000 capturas, la neutralización de 23 cabecillas y el decomiso de alrededor de 50 toneladas de narcóticos.",
      source: "Presidencia de la República",
      url: "https://www.presidencia.gov.co/prensa/Paginas/Firmes-en-lucha-contra-el-narcoterrorismo-y-la-criminalidad-260907.aspx"
    },
    {
      title: "Gobierno reporta ambiente positivo para discutir el Presupuesto de 2027",
      text: "El Gobierno informó que encontró un ambiente positivo en las comisiones económicas del Congreso para avanzar en la discusión del Presupuesto General de la Nación de 2027. El Ejecutivo mantuvo el monto del proyecto en cerca de $635 billones.",
      source: "Caracol Radio",
      url: "https://caracol.com.co/actualidad/politica/"
    }
  ],
  opposition: [
    {
      title: "Petro busca consolidar su papel como líder de la oposición mientras surgen tensiones en el Pacto Histórico",
      text: "CAMBIO publicó un análisis sobre el primer mes de Gustavo Petro fuera de la Presidencia y su transición hacia el liderazgo de la oposición. El medio documentó diferencias internas en el Pacto Histórico sobre el papel del expresidente, la autonomía de la bancada y la necesidad de renovar los liderazgos del partido.",
      source: "CAMBIO",
      url: "https://cambiocolombia.com/poder/articulo/2026/9/petro-disputas-pacto-historico-oposicion-gobiero-abelardo-espriella-elecciones-regionales"
    }
  ]
}
